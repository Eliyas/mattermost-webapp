...
class LegacySidebar extends React.PureComponent {
    ...
    additionalMenues = () => {
        return (
            <ul
                className='section-view nav nav-pills nav-stacked a11y__section'
                tabIndex='-1'
            >
                <li className='sidebar-section__header'>
                    <Link to={"/" + this.props.currentTeam.name + "/sections/manage-sales/1"} >
                ...
                <li className='sidebar-section__header'>
                    <Link to={"/" + this.props.currentTeam.name + "/sections/market-and-sell/1"} >
                        <h4 role='presentation'>
                            <span>Market and sell</span>
                        </h4>
                    </Link>
                </li>

                <li className='sidebar-section__header'>
                    <Link to={"/" + this.props.currentTeam.name + "/sections/advanced-reports/1"} >
                        <h4 role='presentation'>
